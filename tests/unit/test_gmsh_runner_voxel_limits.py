...
def test_voxel_count_within_limit_returns_mask_and_shape(_patch_gmsh, tmp_path):
...
def test_voxel_count_exceeds_limit_raises_memory_error(_patch_gmsh, monkeypatch, tmp_path):
