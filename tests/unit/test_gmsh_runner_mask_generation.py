...
def test_single_voxel_grid_when_bbox_smaller_than_resolution(patch_gmsh, monkeypatch, tmp_path):
...
def test_multi_voxel_grid_shape_and_mask_length(patch_gmsh, monkeypatch, tmp_path):
...
def test_all_inside_results_in_all_fluid(patch_gmsh, monkeypatch, tmp_path):
...
def test_all_outside_results_in_all_solid(patch_gmsh, monkeypatch, tmp_path):
...
def test_mixed_inside_outside_produces_mixed_mask(patch_gmsh, monkeypatch, tmp_path):
